...
public class Lab_Program_07 {
    ...
    private static void addMovie() {
        ...
        try {
            ...
            System.out.println("Invalid input. Please enter an integer for Movie ID and Duration.");
            scanner.nextLine(); // Clear the invalid input
        }
    }
    ...
    private static void removeMovie() {
        try {
            ...
            System.out.println("Invalid input. Please enter an integer for Movie ID.");
            scanner.nextLine(); // Clear the invalid input
        }
    }
    ...
    private static void addTicket() {
        ...
        try {
            ...
            System.out.println("Invalid input. Please enter an integer for Ticket ID and Movie ID.");
            scanner.nextLine(); // Clear the invalid input
        }
    }
    ...
    private static void cancelTicket() {
        try {
            ...
            System.out.println("Invalid input. Please enter an integer for Ticket ID.");
            scanner.nextLine(); // Clear the invalid input
        }
    }
}